...
| P0-08 | Backup/restore drill script and verification checklist | 0.5d | P0-04 | [x] Successful restore to clean environment with integrity checks | [x] Drill date + result recorded |
