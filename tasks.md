...
| P0-06 | Minimal observability baseline (request id, structured logs, latency/error metrics) | 1d | P0-03 | [x] p50/p95 latency + error rate dashboards available | [x] Runbook for alert response committed |
| P0-07 | Performance budget checks in CI (API latency smoke + bundle budget) | 0.5d | P0-06 | [x] CI fails when thresholds exceeded | [x] Thresholds documented in implementation plan |
...
| P0-09 | Capacity milestone playbook (1k/10k/30k/83k villages) as runbook docs | 1d | P0-04, P0-06 | [x] Runbook defines trigger metrics and exact next actions per milestone | [x] Linked from architecture + implementation docs |
| P0-10 | Service extraction scorecard + decision template | 0.5d | P0-02, P0-06 | [x] Measurable extraction thresholds published and review cadence defined | [x] Template used in one example review |
| P0-11 | National onboarding risk register operationalization | 1d | P0-09 | [x] Top risks have owner, signal, mitigation, fallback | [x] Monthly review cadence documented |
| P0-12 | Phase 0 exit review and sign-off | 0.5d | P0-01..P0-11 | [x] All mandatory checklists complete with evidence links | [x] Sign-off note published in docs |
